...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'~help','Type ~help',`${client.users.size} Members`,'~inv','By: Omar | ON'];
    var i = -1;
    var j = 0;
